...
util.request = function (option) {
  ...
  // if (option.url == 'entry/wxapp/AddOrder') {
...
// 封装计算距离方法
util.location = function (lat1, lat2, lng1, lng2) {
...
// 封装计算最低价格方法
util.price = function (a) {
  var list = []
  a.map(function (item) {
    var obj = {};
    obj.a = item.online_price;
    obj.b = item.original_price;
    list.push(obj);
  })
  return list
}
util.compare = function (list) {
  var a = list.a
  var b = list.b
  if (a < b) {
    return -1
